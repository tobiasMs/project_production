                ...
                <div class="container">
                    <div class="hero-content app-hero-content text-center">
                        <div class="row justify-content-md-center">
                            <div class="col-md-10">
                                <h1 class="wow fadeInUp" data-wow-delay="0s">Dashboard Kegiatan</h1>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="services-icon">
                                            <img src="{{ asset('asset_public/assets/logos/icon1.png') }}" height="60" width="60" alt="Service">
                                        </div>
                                    ...
                                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="services-icon">
                                            <img class="icon-2" src="{{ asset('asset_public/assets/logos/icon2.png') }}" height="60" width="60" alt="Service">
                                        </div>
                                        <div class="services-description">
                                    ...
                                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
                                        <div class="services-icon">
                                            <img class="icon-3" src="{{ asset('asset_public/assets/logos/icon3.png') }}" height="60" width="60" alt="Service">
                                        </div>
                                        <div class="services-description">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
                                        <div class="icon">
                                            <img src="{{ asset('asset_public/assets/logos/cart2.png') }}" alt="Icon">
                                        </div>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="table-right wow fadeInUp" data-wow-delay="0.6s">
                                        <div class="icon">
                                            <img src="{{ asset('asset_public/assets/logos/cart1.png') }}" alt="Icon">
                                        </div>
                                        <div class="pricing-details">
                                            <h2>Premium Plan</h2>
                                            <span>$19.99</span>
            ...
            <div class="client-section">
                <div class="container text-center">
                    <div class="clients owl-carousel owl-theme">
                        <div class="single">
                            <img src="{{ asset('asset_public/assets/logos/logo1.png') }}" alt="">
                        </div>
                        <div class="single">
                            <img src="{{ asset('asset_public/assets/logos/logo2.png') }}" alt="">
                        </div>
                        <div class="single">
                            <img src="{{ asset('asset_public/assets/logos/logo3.png') }}" alt="">
                        </div>
                        <div class="single">
                            <img src="{{ asset('asset_public/assets/logos/logo4.png') }}" alt="">
                        </div>
                        <div class="single">
                            <img src="{{ asset('asset_public/assets/logos/logo6.png') }}" alt="">
                        </div>
                        <div class="single">
                            <img src="{{ asset('asset_public/assets/logos/logo7.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
